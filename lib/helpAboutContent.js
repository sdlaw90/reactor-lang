    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "D’autres langues d’interface sont ajoutées au fil du temps, et la couverture s’élargit à mesure que le contenu en langue maternelle se remplit.",
        ],
      },
      {
          ...
          buckets: [
            {
              label: "En cours",
              items: [
                { title: "SquirreLingo dans plus de langues", badge: "Disponible", badgeType: "done", desc: "Toute l’interface s’adapte désormais à ta langue maternelle — détectée automatiquement, avec un sélecteur. D’autres langues maternelles arrivent progressivement." },
