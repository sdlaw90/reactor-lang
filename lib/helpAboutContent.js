    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "More interface languages are being added over time, and coverage keeps widening as native-language content fills in. A few corners are still English for everyone — the *How to use SquirreLingo* tour, the *Grammar Gym* page, and some status and error screens — and they’re next on the list.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Com o tempo, mais idiomas de interface vão sendo adicionados, e a cobertura se amplia à medida que o conteúdo em cada idioma nativo vai sendo preenchido. Alguns cantos ainda estão em inglês para todo mundo — o tour *Como usar o SquirreLingo*, a página do *Grammar Gym* e algumas telas de status e de erro — e são os próximos da lista.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "D’autres langues d’interface sont ajoutées au fil du temps, et la couverture s’élargit à mesure que le contenu en langue maternelle se remplit. Quelques recoins restent en anglais pour tout le monde — la visite *Comment utiliser SquirreLingo*, la page du *Grammar Gym* et certains écrans d’état ou d’erreur — et ils sont les prochains sur la liste.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Col tempo vengono aggiunte altre lingue dell’interfaccia, e la copertura si allarga man mano che i contenuti in lingua madre si completano. Qualche angolo resta in inglese per tutti — il tour *Come usare SquirreLingo*, la pagina del *Grammar Gym* e alcune schermate di stato o di errore — e sono i prossimi della lista.",
        ],
      },
      {
