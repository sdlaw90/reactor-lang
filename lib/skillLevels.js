...
const LEVEL_LABELS = {
  none: { en: "No experience", es: "Sin experiencia", pt: "Sem experiência" },
  beginner: { en: "Beginner", es: "Principiante", pt: "Iniciante" },
  intermediate: { en: "Intermediate", es: "Intermedio", pt: "Intermediário" },
  expert: { en: "Advanced", es: "Avanzado", pt: "Avançado" },
  native: { en: "Native / fluent", es: "Nativo / fluido", pt: "Nativo / fluente" },
};
...
const LEVEL_DESCRIPTIONS = {
  none: { en: "Brand new — questions start from absolute basics.", es: "Empiezas de cero — las preguntas parten de lo más básico.", pt: "Totalmente novo — as perguntas começam do zero absoluto." },
  beginner: { en: "You know a little — rounds lean toward everyday words and simple sentences.", es: "Sabes un poco — las rondas se inclinan hacia palabras cotidianas y frases sencillas.", pt: "Você sabe um pouco — as rodadas priorizam palavras do dia a dia e frases simples." },
  intermediate: { en: "You can hold a conversation — rounds lean toward richer grammar and phrasing.", es: "Puedes mantener una conversación — las rondas se inclinan hacia gramática y expresiones más ricas.", pt: "Você consegue conversar — as rodadas priorizam gramática e expressões mais ricas." },
  expert: { en: "You're comfortable — rounds lean toward nuance, idioms, and tricky details.", es: "Te sientes cómodo — las rondas se inclinan hacia matices, modismos y detalles difíciles.", pt: "Você se sente à vontade — as rodadas priorizam nuances, expressões idiomáticas e detalhes mais complicados." },
  native: { en: "No difficulty bias — everything in the track is fair game.", es: "Sin sesgo de dificultad — todo el contenido del idioma entra en juego.", pt: "Sem viés de dificuldade — todo o conteúdo do idioma pode aparecer." },
};
