...
const LEVEL_LABELS = {
  none: { en: "No experience", es: "Sin experiencia" },
  beginner: { en: "Beginner", es: "Principiante" },
  intermediate: { en: "Intermediate", es: "Intermedio" },
  expert: { en: "Advanced", es: "Avanzado" },
  native: { en: "Native / fluent", es: "Nativo / fluido" },
};
...
const LEVEL_DESCRIPTIONS = {
  none: { en: "Brand new — questions start from absolute basics.", es: "Empiezas de cero — las preguntas parten de lo más básico." },
  beginner: { en: "You know a little — rounds lean toward everyday words and simple sentences.", es: "Sabes un poco — las rondas se inclinan hacia palabras cotidianas y frases sencillas." },
  intermediate: { en: "You can hold a conversation — rounds lean toward richer grammar and phrasing.", es: "Puedes mantener una conversación — las rondas se inclinan hacia gramática y expresiones más ricas." },
  expert: { en: "You're comfortable — rounds lean toward nuance, idioms, and tricky details.", es: "Te sientes cómodo — las rondas se inclinan hacia matices, modismos y detalles difíciles." },
  native: { en: "No difficulty bias — everything in the track is fair game.", es: "Sin sesgo de dificultad — todo el contenido del idioma entra en juego." },
};
