...
const LEVEL_LABELS = {
  none: { en: "No experience", es: "Sin experiencia", pt: "Sem experiência", fr: "Aucune expérience" },
  beginner: { en: "Beginner", es: "Principiante", pt: "Iniciante", fr: "Débutant" },
  intermediate: { en: "Intermediate", es: "Intermedio", pt: "Intermediário", fr: "Intermédiaire" },
  expert: { en: "Advanced", es: "Avanzado", pt: "Avançado", fr: "Avancé" },
  native: { en: "Native / fluent", es: "Nativo / fluido", pt: "Nativo / fluente", fr: "Natif / courant" },
};
...
const LEVEL_DESCRIPTIONS = {
  none: { en: "Brand new — questions start from absolute basics.", es: "Empiezas de cero — las preguntas parten de lo más básico.", pt: "Totalmente novo — as perguntas começam do zero absoluto.", fr: "Tu pars de zéro — les questions commencent par les bases absolues." },
