...
import { BarChart2, Sparkles, X, ShieldCheck, Info, Compass } from "lucide-react";
          ...
          <div style={styles.drawer} className="fadein">
            ...
            <div style={styles.scrollBody}>
              <div style={styles.navList}>
                ...
                <NavItem icon={<Compass size={18} />} label="How to use SquirreLingo" onClick={() => go("/guide")} />
                ...
                {isAdmin && (
                  <NavItem icon={<ShieldCheck size={18} />} label="Admin" onClick={() => go("/admin")} />
                )}
              </div>
