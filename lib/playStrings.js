const STRINGS = {
  ...
  clTitle: { en: "Changelog", es: "Registro de cambios" },
  clCurrentlyPublished: { en: "Currently published:", es: "Versión actual:" },
  wnTitle: { en: "What's new", es: "Novedades" },
  wnSeeFullChangelog: { en: "See full changelog", es: "Ver el registro completo" },
