const STRINGS = {
  ...
  sectionPractice: { en: "Practice", es: "Practicar", pt: "Praticar" },
  sectionListen: { en: "Listen", es: "Escuchar", pt: "Ouvir" },
  sectionSpeak: { en: "Speak", es: "Hablar", pt: "Falar" },
  soonTag: { en: "soon", es: "pronto", pt: "em breve" },
  whatsOnThisPage: { en: "What's on this page?", es: "¿Qué hay en esta página?", pt: "O que tem nesta página?" },
  reviewBadgeLabel: { en: "Community review in progress", es: "Revisión de la comunidad en curso", pt: "Revisão da comunidade em andamento" },
  homeGreeting: { en: "Welcome", es: "¡Bienvenido/a", pt: "Bem-vindo(a)" },
