const STRINGS = {
  ...
  sectionPractice: { en: "Practice", es: "Practicar" },
  sectionListen: { en: "Listen", es: "Escuchar" },
  sectionSpeak: { en: "Speak", es: "Hablar" },
  soonTag: { en: "Soon", es: "Pronto" },
  comingSoonTitle: { en: "Coming soon", es: "Próximamente" },
  comingSoonListenBody: {
    en: "Listening practice is on the way — hear questions out loud and answer what you heard. Same categories, same short rounds.",
    es: "La práctica de escucha está en camino — escucha las preguntas en voz alta y responde lo que oíste. Mismas categorías, mismas rondas cortas.",
  },
  comingSoonSpeakBody: {
    en: "Speaking practice is on the way — say your answers out loud instead of tapping them. Same categories, same short rounds.",
    es: "La práctica de habla está en camino — di tus respuestas en voz alta en lugar de tocarlas. Mismas categorías, mismas rondas cortas.",
  },
  comingSoonDisclaimer: {
    en: "No dates, no promises — things ship when they're ready.",
    es: "Sin fechas ni promesas — las cosas se lanzan cuando están listas.",
  },
  seeWhatsPlanned: { en: "See what else is planned", es: "Mira qué más está planeado" },
  backToPractice: { en: "Back to practice", es: "Volver a practicar" },
};
