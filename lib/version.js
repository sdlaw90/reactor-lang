...
export const CHANGELOG = [
  {
    ...
    date: "2026-07-25",
    changes: [
      "Newest native language available: Spanish. Set your native language to Spanish and the whole app adapts to it — the menus, Settings, sign-in and onboarding, the subtitle under each question, the answer choices, the explanations and the Word Bank all appear in your native language, on every language you can study. What you're learning still leads each question, so the immersion is unchanged — your native language now rides underneath instead of English.",
      "SquirreLingo now detects your device's language when you first arrive and switches automatically, with a language switcher in the corner to change it whenever you like.",
      "A new card shows how a word changes from country to country and region to region — highlighting the form used where you're from, and how it's said elsewhere.",
