...
export const CURRENT_VERSION = "2.21.2";
...
export const CHANGELOG = [
  ...
  },
  {
    ...
    changes: [
      ...
      "New database columns (native_language, current_level on beta applications; sessions_completed, continued_use_likelihood, recommend_likelihood on feedback) for the most commonly-filtered answers, with the rest captured in a details JSON column so nothing gets lost",
    ],
  },
  {
    version: "2.20.0",
  ...
  },
  {
    ...
    date: "2026-07-07",
    changes: [
      "Fixed the feedback-form database migration failing to apply — it used gen_random_uuid(), which needs the pgcrypto extension explicitly enabled; switched to the same \"bigint generated always as identity\" pattern the rest of the schema already uses",
