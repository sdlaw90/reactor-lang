...
export const CURRENT_VERSION = "2.25.0-beta.4";
...
export const CHANGELOG = [
  {
    ...
    date: "2026-07-10",
    changes: [
      "The About page now has its own entry in the profile-picture menu, next to Help — previously it was only reachable through the Help page or the first-login welcome popup",
    ],
  },
  {
    ...
    date: "2026-07-10",
    changes: [
      "New: a \"What's next\" section on the About page — a quick look at what's planned (deeper content per language, mastery quizzes with star rankings, alphabet lessons, listening & speaking practice, and more). No dates on anything — things ship when they're ready",
      "New: a Practice / Listen / Speak switch above the Quick Quiz / Lessons toggle — Listen and Speak are the planned audio practice sections and show a Coming Soon page for now, marked with a small \"Soon\" tag",
    ],
  },
  {
