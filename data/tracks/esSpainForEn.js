...
const BANK = {
  vocab: [
    ["¿Cómo se dice 'computer' en español (España)?", ["el ordenador", "la computadora", "el celular", "el ratón"], 0,
      { en: "In Spain, 'computer' is 'el ordenador'. Latin America uses 'la computadora' instead — same meaning, different region.", es: "En España, 'computer' es 'el ordenador'. En Latinoamérica se dice 'la computadora' — mismo significado, distinta región." }],
    ["¿Cómo se dice 'cell phone' en español (España)?", ["el móvil", "el celular", "el teléfono grande", "la pantalla"], 0,
      { en: "Spain says 'el móvil'; Latin America says 'el celular'. Both mean cell phone.", es: "España dice 'el móvil'; Latinoamérica dice 'el celular'. Ambos significan cell phone." }],
    ["¿Cómo se dice 'juice' en español (España)?", ["el zumo", "el jugo", "el agua", "la leche"], 0,
      { en: "'El zumo' is the Spain word for juice. 'El jugo' is the Latin American equivalent.", es: "'El zumo' es la palabra de España para juice. 'El jugo' es el equivalente latinoamericano." }],
  ],
  verbo: [
    ["Vosotros _____ (tener) razón.", ["tenéis", "tienen", "tenemos", "tienes"], 0,
      { en: "'Vosotros' is the informal plural 'you all' used only in Spain — Latin America uses 'ustedes' instead, even informally.", es: "'Vosotros' es la forma informal de 'ustedes' que se usa solo en España — Latinoamérica usa 'ustedes' incluso en contextos informales." }],
    ["¿Vosotros _____ (querer) venir a la fiesta?", ["queréis", "quieren", "queremos", "quieres"], 0,
      { en: "Vosotros pairs with the '-áis/-éis' verb ending — a form that doesn't exist at all in Latin American Spanish.", es: "Vosotros va con la terminación '-áis/-éis' — una forma que no existe en el español latinoamericano." }],
    ["Vosotras _____ (ir) a la fiesta esta noche.", ["vais", "van", "vamos", "vas"], 0,
      { en: "'Vosotras' (feminine 'you all') takes 'vais'. Recognizing this form is essential for understanding Spain Spanish speech and media.", es: "'Vosotras' usa 'vais'. Reconocer esta forma es clave para entender el habla y los medios de España." }],
  ],
  trad: [
    ["Translate: 'Okay, sounds good.'", ["Vale, genial.", "Bueno, está caro.", "Sí, es verdad.", "No, gracias."], 0,
      { en: "'Vale' is the extremely common Spain word for 'okay' — rarely used this way in Latin America.", es: "'Vale' es la palabra muy común en España para decir 'okay' — poco usada así en Latinoamérica." }],
    ["Translate: 'Dude, look at this.'", ["Tío, mira esto.", "Señor, mire esto.", "Amigo, compra esto.", "Chico, vende esto."], 0,
      { en: "'Tío/tía' is Spain slang for 'dude/mate' among friends — not literally 'uncle/aunt' in this context.", es: "'Tío/tía' es jerga de España para 'dude/mate' entre amigos — no significa literalmente 'uncle/aunt' aquí." }],
  ],
};
...
const FONO_BANK = [
  { text: "Gracias por todo.", sound: "GRAH-thyahs pohr TOH-doh",
  ...
  { text: "¿Vosotros venís también?", sound: "boh-SOH-trohs beh-NEES tahm-BYEHN",
