// Track: English, for a Spanish speaker. Same shape as esForEn.js — this is a
// STARTER SET, not the full thing. Add more entries to BANK/FONO_BANK following
// the exact same pattern and the app automatically picks them up (no other
// code changes needed). Categories here: vocab, gram (grammar/prepositions —
...
const BANK = {
  vocab: [
    ["'Actually' se traduce como...", ["en realidad", "actualmente", "realmente rápido", "de hecho ahora"], 0,
      { en: "'Actually' is a false friend — it means 'en realidad', not 'actualmente' (currently).", es: "'Actually' es un falso amigo — significa 'en realidad', no 'actualmente'." }],
    ["'Embarrassed' se traduce como...", ["avergonzado", "embarazada", "embargado", "abrumado"], 0,
      { en: "Classic false-friend trap: 'embarrassed' means avergonzado, not 'embarazada' (pregnant).", es: "Trampa clásica de falso amigo: 'embarrassed' significa avergonzado, no 'embarazada'." }],
    ["'Library' se traduce como...", ["biblioteca", "librería", "libro grande", "estantería"], 0,
      { en: "Another false friend: 'library' is biblioteca. 'Librería' (bookstore) is a different word: 'bookstore'.", es: "Otro falso amigo: 'library' es biblioteca. 'Librería' en inglés se dice 'bookstore'." }],
  ],
  gram: [
    ["I have lived here _____ five years.", ["for", "since", "during", "at"], 0,
      { en: "'For' pairs with a duration (five years); 'since' pairs with a starting point (2019, June).", es: "'For' va con una duración (cinco años); 'since' va con un punto de partida (2019, junio)." }],
    ["She is interested _____ learning English.", ["in", "on", "for", "at"], 0,
      { en: "'Interested in' is the fixed preposition pairing — Spanish 'interesado en' matches, but many other verb+preposition pairs don't translate directly.", es: "'Interested in' es la pareja fija; 'interesado en' coincide, pero muchas otras combinaciones verbo+preposición no se traducen igual." }],
    ["He _____ to the store yesterday.", ["went", "goed", "gone", "go"], 0,
      { en: "'Go' is irregular: went (past), not 'goed'.", es: "'Go' es irregular: went (pasado), no 'goed'." }],
  ],
  trad: [
    ["Translate: 'Ya lo tengo controlado.'", ["I've got it handled.", "I have it controlled.", "I already have control.", "I got the control."], 0,
      { en: "'I've got it handled' is the natural English idiom — a literal word-for-word translation sounds off.", es: "'I've got it handled' es la expresión natural en inglés; la traducción literal suena rara." }],
    ["Translate: 'No es para tanto.'", ["It's not a big deal.", "It's not for so much.", "It isn't too much.", "It's not that much."], 0,
      { en: "'It's not a big deal' is the natural equivalent — not a literal translation.", es: "'It's not a big deal' es el equivalente natural, no una traducción literal." }],
  ],
};
...
const FONO_BANK = [
  { text: "What are you going to do?", sound: "wuh-DUH-yuh GUH-nuh doo",
  ...
  { text: "Did you eat yet?", sound: "DID-juh EET yet",
