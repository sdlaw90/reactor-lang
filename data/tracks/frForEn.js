...
const BANK = {
  vocab: [
    ...
    ["'Chien' signifie...", ["dog", "cat", "bird", "horse"], 0,
      { en: "'Chien' means dog.", es: "'Chien' significa perro." }, "A1"],
    ["'Voiture' signifie...", ["car", "train", "bicycle", "boat"], 0,
      { en: "'Voiture' means car.", es: "'Voiture' significa auto." }, "A1"],
    ["'Argent' signifie...", ["money AND silver (same word)", "gold only", "wallet", "bank"], 0,
      { en: "'Argent' means both money and the metal silver — the exact same word, with context deciding which sense applies.", es: "'Argent' significa tanto dinero como el metal plata — la misma palabra exacta, y el contexto decide cuál sentido aplica." }, "A2"],
    ["'Bureau' signifie...", ["office/desk", "bureau (dresser) only", "meeting room only", "briefcase"], 0,
      { en: "'Bureau' means office or desk in everyday French — a broader use than the narrower English \"bureau\" (a dresser/chest of drawers).", es: "'Bureau' significa oficina o escritorio en el francés cotidiano — un uso más amplio que el inglés \"bureau\" (más restringido a una cómoda)." }, "B1"],
    ["'Ennuyeux' signifie...", ["boring", "annoying", "worrying", "difficult"], 0,
      { en: "False friend — 'ennuyeux' means boring. \"Annoying\" is 'énervant' or 'agaçant' in French.", es: "Falso amigo — 'ennuyeux' significa aburrido. \"Molesto\" es 'énervant' o 'agaçant' en francés." }, "B2"],
    ["'Blessé' signifie...", ["injured/hurt", "blessed (religious)", "tired", "embarrassed"], 0,
      { en: "False friend — 'blessé' means injured or hurt. \"Blessed\" (religious sense) is 'béni' in French.", es: "Falso amigo — 'blessé' significa herido o lastimado. \"Bendecido\" (sentido religioso) es 'béni' en francés." }, "B2"],
    ...
    ["'Rester' signifie...", ["to stay/remain", "to rest", "to leave", "to return"], 0,
      { en: "False friend — 'rester' means to stay or remain. \"To rest\" is 'se reposer' in French.", es: "Falso amigo — 'rester' significa quedarse o permanecer. \"Descansar\" es 'se reposer' en francés." }, "B1"],
    ["'Bras' signifie...", ["arm", "leg", "hand", "shoulder"], 0,
      { en: "'Bras' means arm.", es: "'Bras' significa brazo." }, "A2"],
    ["'Cœur' signifie...", ["heart", "head", "chest (body part)", "stomach"], 0,
      { en: "'Cœur' means heart, both the organ and emotionally (as in English).", es: "'Cœur' significa corazón, tanto el órgano como en sentido emocional (como en español)." }, "A2"],
  ...
  gram: [
    ...
    ["Je voudrais ___ pain.", ["du", "le", "un", "de"], 0,
      { en: "'Du' (de + le) is a partitive article, used for an unspecified quantity of something uncountable like bread — French requires this article where English just says \"some bread\" or even nothing at all.", es: "'Du' (de + le) es un artículo partitivo, usado para una cantidad no especificada de algo incontable como el pan — el francés requiere este artículo donde el inglés solo dice \"algo de pan\" o incluso nada." }, "B1"],
    ["Combien de livres as-tu? J'___ ai trois.", ["en", "y", "le", "les"], 0,
      { en: "The pronoun 'en' replaces \"de + a noun\" already mentioned — here standing in for \"de livres\" (\"of books\"), so you don't repeat it.", es: "El pronombre 'en' reemplaza \"de + un sustantivo\" ya mencionado — aquí sustituye \"de livres\" (\"de libros\"), para no repetirlo." }, "B2"],
    ["Elle ___ levée tôt ce matin.", ["s'est", "a", "est", "s'a"], 0,
      { en: "Reflexive verbs always use 'être' as their auxiliary in the passé composé, and the past participle agrees with the subject's gender — 's'est levée' (feminine), not 's'est levé'.", es: "Los verbos reflexivos siempre usan 'être' como auxiliar en el pretérito compuesto, y el participio pasado concuerda con el género del sujeto — 's'est levée' (femenino), no 's'est levé'." }, "B2"],
    ...
    ["Je ___ un café, s'il vous plaît.", ["voudrais", "veux", "voulais", "voudrai"], 0,
      { en: "'Voudrais' is the conditional form of 'vouloir' (to want) — using the conditional instead of the direct 'veux' is the standard polite way to order or request something in French.", es: "'Voudrais' es la forma condicional de 'vouloir' (querer) — usar el condicional en vez del directo 'veux' es la forma estándar y cortés de pedir algo en francés." }, "A2"],
    ["Je ___ demain matin.", ["partirai", "pars", "partais", "suis parti"], 0,
      { en: "The future tense 'partirai' (I will leave) is formed by adding future endings directly onto the infinitive 'partir' — a regular, predictable pattern for most verbs.", es: "El tiempo futuro 'partirai' (partiré) se forma añadiendo terminaciones futuras directamente al infinitivo 'partir' — un patrón regular y predecible para la mayoría de los verbos." }, "B1"],
    ["La femme ___ parle est ma sœur.", ["qui", "que", "dont", "où"], 0,
      { en: "'Qui' is the relative pronoun used when the following clause needs a subject — here, 'qui' is the one doing the speaking.", es: "'Qui' es el pronombre relativo usado cuando la siguiente cláusula necesita un sujeto — aquí, 'qui' es quien habla." }, "B2"],
  ],
  trad: [
