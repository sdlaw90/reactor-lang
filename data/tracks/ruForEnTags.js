...
export const THEMES = [
  { id: "numbers-time", en: "Numbers, dates & time", ru: "Числа и время", pt: "Números e tempo", fr: "Nombres, dates et heures", es: "Números y tiempo", it: "Numeri e tempo" },
  { id: "directions", en: "Directions", ru: "Направления", pt: "Direções", fr: "Directions", es: "Direcciones", it: "Indicazioni" },
  { id: "shopping", en: "Shopping", ru: "Покупки", pt: "Compras", fr: "Achats", es: "Compras", it: "Acquisti" },
  { id: "restaurant", en: "Restaurant & food", ru: "Еда", pt: "Restaurante", fr: "Restaurant", es: "Restaurante", it: "Ristorante" },
  { id: "travel", en: "Travel", ru: "Путешествия", pt: "Viagens", fr: "Voyages", es: "Viajes", it: "Viaggi" },
  { id: "medical", en: "Medical & doctor", ru: "Здоровье", pt: "Saúde", fr: "Santé", es: "Salud", it: "Salute" },
  { id: "small-talk", en: "Small talk", ru: "Разговор", pt: "Conversa", fr: "Conversation", es: "Conversación", it: "Conversazione" },
  { id: "work", en: "Work & office", ru: "Работа", pt: "Trabalho", fr: "Travail", es: "Trabajo", it: "Lavoro" },
  { id: "emotions", en: "Emotions", ru: "Эмоции", pt: "Emoções", fr: "Émotions", es: "Emociones", it: "Emozioni" },
];
...
const RAW = {
  ...
  "Я ___ по-русски. (speak)": { grammar: { tense: { en: "Present", ru: "Настоящее", es: "Presente", pt: "Presente", fr: "Présent", it: "Presente" }, why: { en: "conjugating говорить (2nd conj.) in the present", ru: "настоящее время глагола 'говорить'", es: "conjugar говорить (2.ª conj.) en presente", pt: "conjugar говорить (2.ª conj.) no presente", fr: "conjuguer говорить (2e conj.) au présent", it: "coniugare говорить (2ª coniug.) al presente" } }, person: { en: "я (1st sing.)", ru: "я", es: "я (1.ª pers. sing.)", pt: "я (1.ª pess. sing.)", fr: "я (1re pers. sing.)", it: "я (1ª pers. sing.)" } },
  "Она ___ домой.": { grammar: { tense: { en: "Past", ru: "Прошедшее", es: "Pasado", pt: "Passado", fr: "Passé", it: "Passato" }, why: { en: "the past tense agrees with the subject's GENDER, not person (она → -ла)", ru: "прошедшее согласуется по роду: она → пошла", es: "el pasado concuerda en GÉNERO con el sujeto, no en persona (она → -ла)", pt: "o passado concorda em GÊNERO com o sujeito, não em pessoa (она → -ла)", fr: "le passé s’accorde en GENRE avec le sujet, pas en personne (она → -ла)", it: "il passato concorda nel GENERE con il soggetto, non nella persona (она → -ла)" } }, person: { en: "она (fem.)", ru: "она", es: "она (fem.)", pt: "она (fem.)", fr: "она (fém.)", it: "она (femm.)" } },
  "Дети ___ домой. (went)": { grammar: { tense: { en: "Past", ru: "Прошедшее", es: "Pasado", pt: "Passado", fr: "Passé", it: "Passato" }, why: { en: "the past tense agrees in NUMBER — a plural subject takes -и", ru: "прошедшее во множественном числе: -и", es: "el pasado concuerda en NÚMERO — un sujeto plural lleva -и", pt: "o passado concorda em NÚMERO — um sujeito plural leva -и", fr: "le passé s’accorde en NOMBRE — un sujet pluriel prend -и", it: "il passato concorda nel NUMERO — un soggetto plurale prende -и" } }, person: { en: "они (plur.)", ru: "они", es: "они (plur.)", pt: "они (plur.)", fr: "они (plur.)", it: "они (plur.)" } },
  "Я ___ книгу вчера и закончил её.": { grammar: { tense: { en: "Perfective past", ru: "Прошедшее (сов. вид)", es: "Pasado perfectivo", pt: "Passado perfectivo", fr: "Passé perfectif", it: "Passato perfettivo" }, why: { en: "a finished action needs the perfective, not the imperfective past", ru: "завершённое действие — совершенный вид", es: "una acción acabada exige el perfectivo, no el pasado imperfectivo", pt: "uma ação concluída exige o perfectivo, não o passado imperfectivo", fr: "une action achevée exige le perfectif, pas le passé imperfectif", it: "un'azione conclusa richiede il perfettivo, non il passato imperfettivo" } }, person: { en: "я (1st sing.)", ru: "я", es: "я (1.ª pers. sing.)", pt: "я (1.ª pess. sing.)", fr: "я (1re pers. sing.)", it: "я (1ª pers. sing.)" } },
  "Завтра я ___ это письмо и отправлю его. (will write)": { grammar: { tense: { en: "Perfective future", ru: "Будущее (сов. вид)", es: "Futuro perfectivo", pt: "Futuro perfectivo", fr: "Futur perfectif", it: "Futuro perfettivo" }, why: { en: "a single completed future action — perfective present-form", ru: "одно завершённое действие в будущем", es: "una sola acción futura acabada — forma de presente perfectiva", pt: "uma única ação futura concluída — forma de presente perfectiva", fr: "une seule action future achevée — forme de présent perfective", it: "una singola azione futura conclusa — forma di presente perfettiva" } }, person: { en: "я (1st sing.)", ru: "я", es: "я (1.ª pers. sing.)", pt: "я (1.ª pess. sing.)", fr: "я (1re pers. sing.)", it: "я (1ª pers. sing.)" } },
  "Вчера я весь день ___ письма. (was writing)": { grammar: { tense: { en: "Imperfective past", ru: "Прошедшее (несов. вид)", es: "Pasado imperfectivo", pt: "Passado imperfectivo", fr: "Passé imperfectif", it: "Passato imperfettivo" }, why: { en: "an ongoing, unfinished process takes the imperfective past", ru: "длительный процесс — несовершенный вид", es: "un proceso en curso, inacabado, lleva el pasado imperfectivo", pt: "um processo em curso, inacabado, leva o passado imperfectivo", fr: "une action en cours, inachevée, prend le passé imperfectif", it: "un processo in corso, non concluso, vuole il passato imperfettivo" } }, person: { en: "я (1st sing.)", ru: "я", es: "я (1.ª pers. sing.)", pt: "я (1.ª pess. sing.)", fr: "я (1re pers. sing.)", it: "я (1ª pers. sing.)" } },
  "Я ___.": { grammar: { tense: { en: "Present (reflexive)", ru: "Настоящее (возвратный)", es: "Presente (reflexivo)", pt: "Presente (reflexivo)", fr: "Présent (pronominal)", it: "Presente (riflessivo)" }, why: { en: "the -ся suffix turns the action back on the doer ('wash oneself')", ru: "суффикс -ся: действие на себя", es: "el sufijo -ся devuelve la acción sobre el agente ('lavarse')", pt: "o sufixo -ся devolve a ação sobre o agente ('lavar-se')", fr: "le suffixe -ся ramène l’action sur l’agent (« se laver »)", it: "il suffisso -ся riporta l'azione su chi la compie ('lavarsi')" } }, person: { en: "я (1st sing.)", ru: "я", es: "я (1.ª pers. sing.)", pt: "я (1.ª pess. sing.)", fr: "я (1re pers. sing.)", it: "я (1ª pers. sing.)" } },
  "Урок ___ в девять часов. (begins)": { themes: ["numbers-time"], grammar: { tense: { en: "Present (reflexive)", ru: "Настоящее (возвратный)", es: "Presente (reflexivo)", pt: "Presente (reflexivo)", fr: "Présent (pronominal)", it: "Presente (riflessivo)" }, why: { en: "-ся makes it intransitive: the lesson begins on its own", ru: "-ся: непереходное 'начинается'", es: "-ся lo vuelve intransitivo: la lección empieza sola", pt: "-ся torna-o intransitivo: a aula começa sozinha", fr: "-ся le rend intransitif : la leçon commence d’elle-même", it: "-ся lo rende intransitivo: la lezione comincia da sola" } } },
  "Дверь автоматически ___. (opens)": { grammar: { tense: { en: "Present (reflexive)", ru: "Настоящее (возвратный)", es: "Presente (reflexivo)", pt: "Presente (reflexivo)", fr: "Présent (pronominal)", it: "Presente (riflessivo)" }, why: { en: "no external agent → the reflexive -ся form", ru: "без деятеля — возвратная форма на -ся", es: "sin agente externo → forma reflexiva en -ся", pt: "sem agente externo → forma reflexiva em -ся", fr: "sans agent externe → forme pronominale en -ся", it: "nessun agente esterno → la forma riflessiva in -ся" } } },
  "Не ___ окно, на улице холодно! (don't open)": { grammar: { tense: { en: "Imperative (imperfective)", ru: "Повелительное (несов.)", es: "Imperativo (imperfectivo)", pt: "Imperativo (imperfectivo)", fr: "Impératif (imperfectif)", it: "Imperativo (imperfettivo)" }, why: { en: "negative commands normally take the imperfective imperative", ru: "запрет — несовершенный вид повелительного", es: "las órdenes negativas llevan normalmente el imperativo imperfectivo", pt: "as ordens negativas levam normalmente o imperativo imperfectivo", fr: "les ordres négatifs prennent normalement l’impératif imperfectif", it: "gli ordini negativi vogliono di norma l'imperativo imperfettivo" } }, person: { en: "ты (2nd sing.)", ru: "ты", es: "ты (2.ª pers. sing.)", pt: "ты (2.ª pess. sing.)", fr: "ты (2e pers. sing.)", it: "ты (2ª pers. sing.)" } },
  "Он начал ___ эту книгу вчера. (to read)": { grammar: { tense: { en: "Aspect (infinitive)", ru: "Вид (инфинитив)", es: "Aspecto (infinitivo)", pt: "Aspecto (infinitivo)", fr: "Aspect (infinitif)", it: "Aspetto (infinito)" }, why: { en: "phase verbs like начать require an imperfective infinitive", ru: "после 'начать' — инфинитив несовершенного вида", es: "los verbos de fase como начать exigen un infinitivo imperfectivo", pt: "os verbos de fase como начать exigem um infinitivo imperfectivo", fr: "les verbes de phase comme начать exigent un infinitif imperfectif", it: "i verbi di fase come начать richiedono un infinito imperfettivo" } } },
  "Я хочу, чтобы ты ___ домой пораньше. (would come)": { grammar: { tense: { en: "Subjunctive (чтобы)", ru: "Сослагательное (чтобы)", es: "Subjuntivo (чтобы)", pt: "Subjuntivo (чтобы)", fr: "Subjonctif (чтобы)", it: "Congiuntivo (чтобы)" }, why: { en: "чтобы + a wish about someone else takes the past-tense (subjunctive) form", ru: "чтобы + желание о другом — форма прошедшего", es: "чтобы + deseo sobre otra persona lleva la forma de pasado (subjuntiva)", pt: "чтобы + desejo sobre outra pessoa leva a forma de passado (subjuntiva)", fr: "чтобы + souhait à propos d’autrui prend la forme du passé (subjonctif)", it: "чтобы + un desiderio su un'altra persona vuole la forma del passato (congiuntiva)" } }, person: { en: "ты (2nd sing.)", ru: "ты", es: "ты (2.ª pers. sing.)", pt: "ты (2.ª pess. sing.)", fr: "ты (2e pers. sing.)", it: "ты (2ª pers. sing.)" } },
  "Если бы у меня было время, я ___ пришёл.": { grammar: { tense: { en: "Conditional (бы)", ru: "Условное (бы)", es: "Condicional (бы)", pt: "Condicional (бы)", fr: "Conditionnel (бы)", it: "Condizionale (бы)" }, why: { en: "the particle бы + past-tense verb builds the whole conditional", ru: "частица бы + прошедшее = условное наклонение", es: "la partícula бы + verbo en pasado forma todo el condicional", pt: "a partícula бы + verbo no passado forma todo o condicional", fr: "la particule бы + verbe au passé forme à elle seule le conditionnel", it: "la particella бы + verbo al passato forma tutto il condizionale" } }, person: { en: "я (1st sing.)", ru: "я", es: "я (1.ª pers. sing.)", pt: "я (1.ª pess. sing.)", fr: "я (1re pers. sing.)", it: "я (1ª pers. sing.)" } },
  "Я обычно ___ на работу пешком.": { themes: ["work"], grammar: { tense: { en: "Motion verb (habitual)", ru: "Глагол движения (многокр.)", es: "Verbo de movimiento (habitual)", pt: "Verbo de movimento (habitual)", fr: "Verbe de mouvement (habituel)", it: "Verbo di moto (abituale)" }, why: { en: "a habitual, repeated trip takes the multidirectional ходить", ru: "привычное движение — разнонаправленный 'ходить'", es: "un trayecto habitual y repetido lleva el multidireccional ходить", pt: "um trajeto habitual e repetido leva o multidirecional ходить", fr: "un trajet habituel et répété prend le multidirectionnel ходить", it: "un tragitto abituale e ripetuto vuole il multidirezionale ходить" } }, person: { en: "я (1st sing.)", ru: "я", es: "я (1.ª pers. sing.)", pt: "я (1.ª pess. sing.)", fr: "я (1re pers. sing.)", it: "я (1ª pers. sing.)" } },
  "Я обычно ___ на работу на машине. (go — by vehicle)": { themes: ["work", "travel"], grammar: { tense: { en: "Motion verb (by vehicle)", ru: "Глагол движения (транспорт)", es: "Verbo de movimiento (en vehículo)", pt: "Verbo de movimento (de veículo)", fr: "Verbe de mouvement (en véhicule)", it: "Verbo di moto (in veicolo)" }, why: { en: "going by vehicle uses ехать/ездить, not on-foot идти/ходить", ru: "на транспорте — 'ездить', не 'ходить'", es: "ir en vehículo usa ехать/ездить, no идти/ходить a pie", pt: "ir de veículo usa ехать/ездить, não идти/ходить a pé", fr: "aller en véhicule emploie ехать/ездить, pas идти/ходить à pied", it: "andare in veicolo usa ехать/ездить, non идти/ходить a piedi" } }, person: { en: "я (1st sing.)", ru: "я", es: "я (1.ª pers. sing.)", pt: "я (1.ª pess. sing.)", fr: "я (1re pers. sing.)", it: "я (1ª pers. sing.)" } },
  "Поезд ___ в шесть часов. (arrives)": { themes: ["travel", "numbers-time"], grammar: { tense: { en: "Motion prefix (present)", ru: "Приставка движения", es: "Prefijo de movimiento (presente)", pt: "Prefixo de movimento (presente)", fr: "Préfixe de mouvement (présent)", it: "Prefisso di moto (presente)" }, why: { en: "the prefix при- carries the meaning 'arrival'", ru: "приставка при- = прибытие", es: "el prefijo при- aporta el sentido de 'llegada'", pt: "o prefixo при- traz o sentido de 'chegada'", fr: "le préfixe при- porte le sens de « arrivée »", it: "il prefisso при- porta il senso di 'arrivo'" } } },
