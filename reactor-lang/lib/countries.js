// Flags are served as real SVG images from flagcdn.com (a long-standing free
// flag CDN) rather than emoji — Windows doesn't ship flag glyphs in its
// default font, so emoji flags render as plain two-letter codes there. Real
// images work identically on every OS/browser.
export function flagImageUrl(countryCode) {
  if (!countryCode || countryCode.length !== 2) return null;
  return `https://flagcdn.com/${countryCode.toLowerCase()}.svg`;
}

// Full list of countries (ISO 3166-1), sorted alphabetically by name.
