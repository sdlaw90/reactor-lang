...
export function buildFrequencyBank(words, { promptLangName = "español", seed = 20260710 } = {}) {
  ...
  words.forEach((w, i) => {
    ...
    if (i % 2 === 0) {
      // Recognition: Spanish word → English options
      bank.push([
        `'${cap(word)}' significa...`,
      ...
      // Production: English gloss → Spanish options
      bank.push([
        `¿Cómo se dice '${gloss}' en ${promptLangName}?`,
        ...
        tier,
        null,
        { en: `How do you say '${gloss}' in Spanish?` },
      ]);
    }
  });
  return bank;
